...
public class OSScreen extends javax.swing.JInternalFrame {
    ...
    private void searchOS() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Desativar elementos para evitar a quebra do sistema.
                btnCreateOS.setEnabled(false);
    ...
    private void printOs() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                // Exibição da OS através da classe JasperViewer
    ...
    /*private void IdUsername() {
        String sql = "select iduser from userinfo where usr=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(2, txtFunc.getText());
            rs = pst.executeQuery();
            if (rs.next()) {
                String user = rs.getString(2);
                if (user.equals (txtFunc.getText())) {
                    txtIdFunc.setText(rs.getString(1));
                } else {
                    JOptionPane.showMessageDialog(this, "Funcionário não encontrado ou inexistente, verifique as credenciais.");
    ...
    private void rbtDebitoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtDebitoActionPerformed
        // Atribui à variável "pagamento" a String "Débito".
        pagamento = "Débito";
    ...
    private void rbtCreditoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtCreditoActionPerformed
        // Atribui à variável "pagamento" a String "Crédito".
        pagamento = "Crédito";
